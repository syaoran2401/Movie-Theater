        ...
        <div>
            <footer className="py-4 bg-coolGray-100 text-coolGray-900 bg-gray-500 text-white relative" style={{ background: `url(${footerImg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <div className="px-6 space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50 z-5 w-9/12 mx-auto py-20">
                    <div className="grid grid-cols-12 footer__content">
                        <div className="xs:col-span-0  sm:col-span-0 md:col-span-0 lg:col-span-3 xl:col-span-3  md:pb-0 z-10 leftCol pb-6 ">
                            <a href="#Home">
                        ...
                        <div className=" xs:col-span-0 sm:col-span-0 md:col-span-0 lg:col-span-3 xl:col-span-3  text-center md:text-left z-10 middleCol__left">
                        ...
                        <div className=" xs:col-span-12  sm:col-span-6 md:col-span-6 lg:col-span-3 xl:col-span-3  text-center md:text-left  z-10 middleCol__right">
                        ...
                        <div className="xs:col-span-12  sm:col-span-6 md:col-span-6 lg:col-span-3 xl:col-span-3  md:text-left  z-10 text-center rightCol">
                ...
                <div className='border-t-2 z-10 pt-5 pb-3 '>
                    <div className='flex justify-between w-3/4 mx-auto footerBot'>
                        <a href="#home" className='z-10 pl-6 whitespace-nowrap'>Văn Trần Trúc Phương</a>
                        <a href="#home" className='z-10 pr-40 whitespace-nowrap'>Back to top</a>
                    </div>
                </div>
            </footer>
        </div>
